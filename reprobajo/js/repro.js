  ...
  function setMuted(state) {
    ...
    */
    for (var i = 0; i < muteClasses.length; i++) {
      if (!state) {
        muteClasses[i].classList.add("fa-volume-up");
        muteClasses[i].classList.remove("fa-volume-mute");
      } else {
        muteClasses[i].classList.remove("fa-volume-up");
        muteClasses[i].classList.add("fa-volume-mute");
      }
    }
  }
